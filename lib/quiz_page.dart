...
class _QuizPage2State extends State<QuizPage2> {
              ...
              children: <Widget>[
                ListView(
                  children: <Widget>[
                    ListTile(
                      title: Text(
                          'Были ли Вы за границей в течение последних 14 дней?',
  ...
  void finishQuiz() {
    setState(() {
      isQuizEnded = true;
      if (_question_4 == Question_4.no ||
          _question_3 == Question_3.no ||
          _question_2 == Question_2.no ||
          _question_1 == Question_1.no) {
        isQuizSuccess = false;
      }
    });
  }
